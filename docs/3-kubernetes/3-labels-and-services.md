...
> This guide assumes you have completed the K8s setup described in `2-namespaces-configmaps-secrets.md` and have a running Minikube cluster with the four base pods applied.
...
### Updated configurations (added specific env inport for orchestrator)
